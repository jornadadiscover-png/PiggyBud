        ...
        <div className="max-w-md mx-auto pt-8">
          ...
          <div className="w-20 h-20 bg-emerald-500/20 rounded-full flex items-center justify-center mx-auto mb-6">
            ...
            <p className="text-muted-foreground">
              O FinFunny já está na sua tela inicial. Aproveite!
            </p>
            <Button 
              onClick={() => navigate("/")}
    ...
    <div className="min-h-screen bg-gradient-to-br from-background via-background to-primary/5 p-4">
      <div className="max-w-md mx-auto pt-8">
        ...
        <div className="text-center mb-8">
          ...
          <h1 className="text-2xl font-bold mb-2">Instalar FinFunny</h1>
          <p className="text-muted-foreground">
        ...
        {deferredPrompt && (
          <Button
            ...
            className="w-full mb-8 h-14 text-lg bg-primary hover:bg-primary/90"
          >
            ...
            <CardContent className="p-6">
              ...
              <ol className="space-y-4">
                <li className="flex items-start gap-3">
                  <span className="flex-shrink-0 w-8 h-8 bg-primary/20 rounded-full flex items-center justify-center text-sm font-bold">
                    1
                  </span>
                  <div>
                ...
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground flex items-center gap-1">
                      <Plus className="h-4 w-4" /> Role e toque nesta opção
                    </p>
                  </div>
                </li>
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      O FinFunny aparecerá na sua tela inicial!
                    </p>
                  </div>
                </li>
              </ol>
              ...
              <ol className="space-y-4">
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground flex items-center gap-1">
                      <MoreVertical className="h-4 w-4" /> (3 pontinhos) no canto superior
                    </p>
                  </div>
                </li>
                <li className="flex items-start gap-3">
                ...
                <li className="flex items-start gap-3">
                  ...
                  <div>
                    ...
                    <p className="text-sm text-muted-foreground">
                      Pronto! O FinFunny estará no seu celular!
                    </p>
                  </div>
                </li>
              </ol>
